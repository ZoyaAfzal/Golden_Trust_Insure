...
const features = [
  { icon: Users, title: "Trusted by 15,000+ families", desc: "A quarter-century of building lifelong client relationships." },
  { icon: Zap, title: "Instant online quote system", desc: "Compare carriers and bind a policy in under ten minutes." },
  { icon: LifeBuoy, title: "24/7 claims support", desc: "Real humans on call the moment something goes wrong." },
  { icon: EyeOff, title: "No hidden fees — ever", desc: "Transparent commissions and side-by-side carrier comparisons." },
];
      ...
      <div className="container-x grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        >
          <div className="rounded-3xl overflow-hidden aspect-[4/5] shadow-[0_30px_60px_-20px_rgba(13,59,46,0.3)]">
            <img src={teamImage} alt="The Golden Trust Insure team in their Boston office" className="h-full w-full object-cover" />
          </div>
        ...
        <div>
          <SectionHeading
            ...
            title={<>Brokers who answer <em className="text-accent not-italic" style={{ fontStyle: "italic" }}>to you.</em></>}
          ...
          <Button asChild size="lg" className="mt-10 rounded-full bg-primary text-primary-foreground hover:bg-primary-mid px-7 h-12">
